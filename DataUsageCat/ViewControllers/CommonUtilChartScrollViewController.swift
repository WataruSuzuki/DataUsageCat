    ...
    UIScrollViewDelegate
{
    ...
    var networkInterFace: DUCNetworkInterFace!
    ...
    @IBOutlet weak var viewNoDataMsg: UIView!
    @IBOutlet weak var labelNoDataMsg: UILabel!
    ...
    */
    ...
    func setGestureHandlerForFocusView(viewArray: [AnyObject]) {
        for view: UIView in viewArray as! [UIView] {
            let singleTap: UITapGestureRecognizer = UITapGestureRecognizer(target: self, action: #selector(CommonUtilChartScrollViewController.handleFocusViewTap(recognizer:)))
    ...
    @objc func tapSummaryNetworkUsage(sender: AnyObject) {
        //do nothing here. Please override
    }
}
